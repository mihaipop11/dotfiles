...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (pinentry call-graph google-c-style undo-tree company-irony-c-headers autopair flycheck-rust racer rust-mode company-irony irony company-lsp function-args helm-gtags disable-mouse edit-indirect markdown-mode magit helm helm-projectile smooth-scrolling))))
(custom-set-faces
