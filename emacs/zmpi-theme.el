;;; zmpi-theme.el --- A dark theme using different shades of blue

;; Copyright (C) 2020 Mihai Pop

;; Author: Mihai Pop <mihai.pop@codingfactory.ro>
;; Maintainer: Mihai Pop <mihai.pop@codingfactory.ro>
;; Created: 18th Nov 2020
...
;; This theme is inspired from zeno-theme which is released under GPL3.
;; Go to https://github.com/1bharat/zeno-theme for full license details.
...
(defgroup zmpi-theme nil
  "Zmpi-theme options."
  :group 'faces)

(defcustom zmpi-theme-enable-italics nil
...
(let
    (
     ...
     (slantType (if zmpi-theme-enable-italics 'italic 'normal))
